...
function setup() {
  ...
  mario = createSprite(windowWidth/4-150,windowHeight - 170);
...
if(gameState === STORY){
  ...
  if(story === 2){
    ...
    text("A MONSTER HAS KIDNAPPED THE PRINCESS PEACH",windowWidth/2,windowHeight/2);
    ...
    text("MARIO HAVE TO SAVE THE PRINCESS",windowWidth/2,windowHeight/2);
    ...
    text("YOU HAVE TO PLAY THE ROLE OF THE MARIO & SAVE THE PRINCESS",windowWidth/2,windowHeight/2);
    ...
    if(story === 6){
      ...
      pressStart.depth = startlogo.depth + 5;
      pressStartGroup.add(pressStart);
      startButton = createSprite(windowWidth/2,windowHeight/2 + 200);
